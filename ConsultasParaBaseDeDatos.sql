...
-- Consultas para obtener todos los usuarios
SELECT * FROM users;
...
-- Consultas para obtener todas las búsquedas
SELECT * FROM search_queries;

-- Inserciones de ejemplo para las búsquedas
INSERT INTO search_queries (user_id, query)
VALUES 
(1, 'Plataformas de redes sociales populares'),
(2, 'Servicios populares de Internet');

-- Consultas para obtener todos los resultados de búsqueda
